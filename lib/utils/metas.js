...
export const dashboard = function(req, res, next){
  ...
  if (!domain) {
    ...
    res.locals.meta = {
      url: baseURL,
      title: "OGP Toolbox hackathon",
      description: "OGP Toolbox hackathon. Upload your project. Add colaborators. Inform status. Share your app."
    };
...
export const check = function(){
  return function(req, res, next) {
    ...
    if (!metas.image){
      metas.image = "/images/logohack.gif";
    }
