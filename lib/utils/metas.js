...
export const dashboard = function(req, res, next){
  ...
  if (!domain) {
    ...
    res.locals.meta = {
      url: baseURL,
      title: "g0v 公民科技創新獎助金",
      description: "每個專案 30-50 萬、6 個月一期、2019/1/13 提案截止",
      image: "/images/static/fb-2018.png"
    };
  ...
  Dashboard.findOne({ domain: domain }, function(err, dashboard) {
    ...
    res.locals.meta = {
      ...
      image: "/images/static/fb-2019.png",
...
export const check = function(){
  return function(req, res, next) {
    ...
    if (!metas.image){
      metas.image = "/images/static/landing-banner.png";
    }
