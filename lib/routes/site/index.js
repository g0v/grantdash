...
import {homeStack, loginStack, appStack, projectStack, profileStack, embedStack, projectFormRedirect, logout} from './controllers';
...
// LANDING
app.get('/', metas.dashboard, ({params}, res) => res.render('about'));
app.get('/power/', metas.dashboard, ({params}, res) => res.render('power'));
