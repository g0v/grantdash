...
function sendProposalMail({to, project}, callback=errorHandler) {
  transport.sendMail({
    ...
    html: toHtml([
      ...
      '2. 是否確實了解由獎助金支持的工作內容需以開源的形式公開釋出？',
      '3. 請記得點選右上大頭貼，加上[個人簡介](https://grants.g0v.tw/users/profile)，讓評選團隊能更認識您。',
      '4. 在建立專案之後，請記得回到自己的專案頁面填寫提案同意書',
      '5. 分享您的提案，邀請其他人來提供修改提案的意見。也歡迎您加入其他提案討論，激盪出更棒的想法。',
      `6. 歡迎隨時補充您的提案和友善回應[線上討論](${config.discourseUrl})`,
      `7. 建議您訂閱[獎助金一般討論](https://discuss.grants.g0v.tw/c/grants-general)，以及有關自己提案主題的所有回覆（點選圓圈下拉選單，選擇「關注」）。`, '',
      '### 請記得提案內容僅可在 2017/7/29 23:59:59(UTC+8) 之前編修，請在此之前完成所有內容補充',
